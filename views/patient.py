...
class Patient(db.Model):
    ...
    Allergy = db.Column(db.String(200), nullable=False)
    Chat_Id = db.Column(db.String(200), nullable=False)
    password = db.Column(db.String(250), nullable=False)

    def __init__(self, Patient_Id, P_name, Email, Age, Address, Allergy, Chat_Id, password):
    ...
    def json(self):
        return {"Patient_Id": self.Patient_Id, "P_name": self.P_name, "Email": self.Email, "Age": self.Age, "Allergy": self.Allergy, "Address": self.Address, "Chat_Id": self.Chat_Id, "password": self.password}
